package net.thumbtack.school.multithread.task9;
import java.util.*;
import lombok.*;
import net.thumbtack.school.multithread.task9.ttschool.Group;
import net.thumbtack.school.multithread.task9.ttschool.Trainee;
import net.thumbtack.school.multithread.task9.ttschool.TrainingException;
