...
public class TestRectangle3D {
    ...
    public void testSetHeight() throws ColorException {
        Rectangle3D rect3D1 = new Rectangle3D(10, 20, 30, 40, 0, Color.BLUE);
        Rectangle3D rect3D2 = new Rectangle3D(20, 30, 40, 80, 20, Color.BLUE);
        rect3D1.setHeight(30);
        rect3D2.setHeight(40);
        assertEquals(30, rect3D1.getHeight());
        assertEquals(40, rect3D2.getHeight());
    }
}
