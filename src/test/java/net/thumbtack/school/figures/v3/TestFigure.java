...
public class TestFigure {
    ...
    @Test
    public void testEqualsFigure() throws ColorException {
        Figure rect1 = new Rectangle(0, 0, 10, 10, Color.BLUE);
        Figure rect2 = new Rectangle(0, 0, 10, 10, Color.BLUE);
        Figure rect3 = new Rectangle(1, 1, 20, 20, Color.BLUE);
        Figure rect4 = new Rectangle(1, 1, 20, 20, Color.GREEN);
        boolean eq1 = rect1.equals(rect2);
        boolean eq2 = rect1.equals(rect3);
        boolean eq3 = rect2.equals(rect4);
        assertTrue(eq1);
        assertFalse(eq2);
        assertFalse(eq3);
    }
