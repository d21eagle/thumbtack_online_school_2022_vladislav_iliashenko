...
public class TestCylinder {
    ...
    public void testSetHeight() throws ColorException {
        Cylinder cylinder1 = new Cylinder(10, 20, 10, 0, Color.BLUE);
        Cylinder cylinder2 = new Cylinder(10, 20, 10, 20, Color.BLUE);
        cylinder1.setHeight(30);
        cylinder2.setHeight(40);
        assertEquals(30, cylinder1.getHeight());
        assertEquals(40, cylinder2.getHeight());
    }
}
